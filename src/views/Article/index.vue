            ...
            <div v-else-if="article.title" class="article-detail">
                ...
                <van-cell class="user-info" center :border="false">
                    ...
                    <van-button
                        ...
                        @click="onFollow"
                    >关注</van-button>
                    <van-button v-else @click="onFollow" class="1follow-btn" round size="small">已关注</van-button>
                </van-cell>
                <!-- /用户信息 -->
                ...
                <van-popup v-model="isPostComment" position="bottom">
                    <CommentPost :id="article.art_id" @post-succes="onPostSucces"></CommentPost>
                </van-popup>
                ...
                <div class="article-bottom">
                    ...
                    <van-icon name="comment-o" :badge="totalCommontCount" color="#777" />
                    <!-- <van-icon color="#777" name="star-o" /> -->
                    <CollectedBtn v-model="article.is_collected" :articleid="this.article_id" />
                    <!-- <van-icon color="#777" name="good-job-o" /> -->
                    <LikeArticle v-model="article.attitude" :articleid="this.article_id" />
